...
import { couldStartTrivia, isComputedPropertyName } from 'typescript'
      ...
      <Box id="BoxInfo">
        <TabContext value={value}>
          ...
          <TabPanel value="1">
            ...
            {data && <p className="password">{censoredPassword}</p>} <button onClick={handleclick}>hide</button>
          </TabPanel>
